...
exports.osirionStats = void 0;
const https_1 = require("firebase-functions/v2/https");
const firebase_admin_1 = require("../lib/firebase-admin");
const credit_backend_service_1 = require("../lib/credit-backend-service");
const osirion_1 = require("../lib/osirion");
exports.osirionStats = (0, https_1.onRequest)(async (req, res) => {
    // Set CORS headers
    ...
    try {
        ...
        const creditService = new credit_backend_service_1.CreditBackendService();
        const osirionService = new osirion_1.OsirionService();
        ...
        const monthlyLimit = monthlyLimits[subscriptionTier] || 6;
        // Check current usage
        ...
        if (usageDoc.exists) {
            ...
            if ((usageData === null || usageData === void 0 ? void 0 : usageData.lastMonth) === currentMonth) {
        ...
        const creditResult = await creditService.deductCredits(userId, creditCost, actionType, {
            epicId,
            platform,
            lookupType,
            matchLimit
...
//# sourceMappingURL=osirion-stats.js.map