...
export default function FortniteAccountSection() {
  ...
  const [activeTab, setActiveTab] = useState<'epic' | 'manual' | 'tracker'>('epic');
  ...
  return (
    <div className="bg-white/5 border border-white/20 rounded-xl p-6">
      ...
      {activeTab === 'manual' && (
        <div className="text-center space-y-4">
          <p className="text-white/60">Enter your Epic username manually for verification.</p>
          <p className="text-white/40 text-sm">This feature is coming soon.</p>
        </div>
      )}
      ...
      {activeTab === 'tracker' && (
        <div className="text-center space-y-4">
          <p className="text-white/60">Link your Fortnite Tracker account.</p>
          <p className="text-white/40 text-sm">This feature is coming soon.</p>
        </div>
      )}
