      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="animate-slide-up">
            <div className="glass-card w-full max-w-2xl mx-auto lg:mx-0 h-[600px] flex flex-col relative overflow-hidden">
              
              {/* Chat Header */}
              <div className="flex items-center space-x-4 mb-6 pb-4 border-b border-white/10 relative z-10">
                ...
                <div>
                  <div className="text-primary-text font-semibold text-lg">PathGen Coach</div>
                  <div className="text-secondary-text text-sm flex items-center space-x-2">
                    <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse"></div>
                    <span>Online • Analyzing your game</span>
                  </div>
                </div>
              </div>
              ...
              <div className="flex-1 overflow-y-auto space-y-4 mb-4 relative z-10">
                <div className="space-y-4">
                  {/* Question */}
                  <div className="bg-dark-gray/50 rounded-lg p-4 border border-white/20 shadow-lg animate-slide-in-left">
                    <div className="text-secondary-text text-sm mb-2 flex items-center space-x-2">
                      <div className="w-2 h-2 bg-white rounded-full"></div>
                      <span>Question</span>
                    </div>
                    <div className="text-primary-text font-medium leading-relaxed">
                  ...
                  {/* Answer */}
                  {showAnswer && (
                    <div className="bg-white/10 rounded-lg p-4 border border-white/30 shadow-lg backdrop-blur-sm animate-slide-in-right">
                      <div className="text-secondary-text text-sm mb-2 flex items-center space-x-2">
                        <div className="w-2 h-2 bg-white rounded-full animate-pulse"></div>
              ...
              <div className="pt-4 border-t border-white/10 relative z-10">
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-2 text-secondary-text text-sm">
                    <div className="w-2 h-2 bg-white rounded-full animate-pulse"></div>
                    <span>AI is analyzing your gameplay...</span>
                  </div>
                  <div className="text-secondary-text text-xs bg-white/10 px-3 py-1 rounded-full">
